...
Let's create a multinomial logistic regression model to get some inferences about what affects a player's choice of offer.
...
Lets make a function that will return p-values from the result of the regression.
